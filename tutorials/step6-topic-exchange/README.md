# Tutorial for using Topic exchange

This is to deliver the target message to target multiple consumers by using Topic exchange.
...
3. Follow [Topics](https://www.rabbitmq.com/tutorials/tutorial-five-dotnet.html).
